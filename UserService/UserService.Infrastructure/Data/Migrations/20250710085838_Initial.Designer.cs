...
namespace UserService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250710085838_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserService.Core.Models.UserInfo", b =>
                {
                    ...
                    b.Property<string>("ProfileImmageUrl")
                        .HasColumnType("text");

                    b.Property<Dictionary<string, string>>("SocialLinkUrl")
                        .IsRequired()
            ...
            modelBuilder.Entity("UserService.Infrastructure.Identity.RoleIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("UserService.Infrastructure.Identity.RoleIdentity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UserService.Core.Models.UserInfo", b =>
                {
                    b.HasOne("UserService.Infrastructure.Identity.UserIdentity", null)
                        .WithOne("UserInfo")
                        .HasForeignKey("UserService.Core.Models.UserInfo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
